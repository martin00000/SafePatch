...
package com.aland.loader;



import com.aland.ByteKitPlugin;
import com.aland.BytekitException;
...
//    private static final PLogger logger = PLoggerFactory.getLogger(AgentClassLoader.class);
    /**
...
//                    logger.warn("can not invoke ClassLoader.registerAsParallelCapable()",e);
     ...
     */
    public static AgentClassLoader initDefaultLoader() throws BytekitException {
        if (DEFAULT_LOADER == null) {
            synchronized (AgentClassLoader.class) {
                if (DEFAULT_LOADER == null) {
                    DEFAULT_LOADER = new AgentClassLoader(ByteKitPlugin.class.getClassLoader());
                }
            }
        }
        return getDefault();
